...
@Component
public class PersonaTestRunner implements CommandLineRunner {
    ...
    public PersonaTestRunner(GameInitializer gameInitializer, SetUpTeams setUpTeams,
    ...
    public void runGame(com.akshaya.outlast.model.GameConfigOptions options) {
        ...
        try {
            ...
            gameContext.checkpoint("Game Over - Winner Crowned");
    ...
    private String determineMergeTwist(int round) {
        // Cycle twists for merge testing coverage
        if (round == 1) return "NORMAL";
        if (round == 2) return "DOUBLE_VOTE";
        if (round == 3) return "LOSER_NO_VOTE";
        return "LUCKY_NO_ELIMINATION";
    }
}
