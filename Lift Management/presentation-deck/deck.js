/* ==========================================================================
   Lift Management Presentation Deck — Controller Logic
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const SLIDE_DURATION_MS = 8000; // 8 seconds per slide for auto-play

  let currentIndex = 0;
  let isPlaying = false; // Paused by default to let interviewer read at their pace
  ...
  // Global Tab Switcher for Visual / Code / Flow Panes
  ...
  // Initialize deck (paused by default)
  showSlide(0);
  pauseAutoPlay();
});
